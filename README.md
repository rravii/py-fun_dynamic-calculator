...
## Steps to Creating a *Python*-Project *Dynamic Calculator / py-fun*


<!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
The task shows good practices how to create and structure a *Python*
...
Goal of this task is to set-up a new *Python* project following the guidance
from the article.
